...
if [[ "${BUMP}" == "1" ]]; then
  ...
  URL="https://github.com/d99kris/falanet.git"
...
if [[ "${DOC}" == "1" ]]; then
  if [[ -x "$(command -v help2man)" ]]; then
    ...
    help2man -n "ncurses mail" -N -o src/falanet.1 ./build/falanet && ${SED} "s/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man.*/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man./g" src/falanet.1 || exiterr "doc failed, exiting."
  fi
fi
